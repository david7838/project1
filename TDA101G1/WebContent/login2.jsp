...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <div class="fadeIn first">
      <img src="<%=request.getContextPath()%>/img/logo.png" id="icon" alt="User Icon" />
    </div>

    <!-- Login Form -->
    <form method="post" action="<c:url value="/member/login.controller" />">
      <input type="text" id="login" class="fadeIn second" name="account" placeholder="login"><span>${errorMsg.account }</span>
      <input type="text" id="password" class="fadeIn third" name="password" placeholder="password"><span>${errorMsg.password }</span>
